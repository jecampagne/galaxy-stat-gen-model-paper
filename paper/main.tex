...
\begin{figure}
    ...
    \begin{center}
        \centering
        \includegraphics[width=0.8\textwidth]{fig-original_samples_ex.pdf}
        %\caption{xxx}
    \end{center}
    \end{subfigure}%
    \begin{subfigure}[t]{0.30\columnwidth}
    \begin{center}
        \centering
        \includegraphics[width=0.8\textwidth]{fig-diffusion_samples_ex.pdf}
        %\caption{xxx}
    \end{center}
    \end{subfigure}%
%    \vspace{5mm}
    \begin{subfigure}[t]{0.30\columnwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{fig-glow_samples_ex.pdf}
        %\caption{xxx}
    \end{subfigure}
    \caption{Illustration of the generation of some samples from the diffusion-based (\texttt{U-Net} denoiser) and the \texttt{Glow} flow-based models trained with $N=10^5$ images. On the left some original images are also displayed c-for visual comparison.}
