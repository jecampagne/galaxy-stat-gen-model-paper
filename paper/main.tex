...
\newcommand{\Ex}[0]{\ensuremath{\mathbb{E}}}
\newcommand{\Dist}[0]{\ensuremath{\mathbb{D}_{\mathsf{KL}}}}
...
%
The generative models assume that the observations $\bm{x}$ are described by a probability distribution $\bm{p(x)}$ and aim to give a certain representation and leads to different strategies.
