...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.30\columnwidth}
        \centering
        \raisebox{0mm}{\includegraphics[width=0.8\textwidth]{fig-glow_samples_gray.pdf}}
        %\caption{xxx}
    \end{subfigure}
...
%		\includegraphics[width=0.8\textwidth, trim={0 0 0 25cm},clip=True]{fig-UNet_100000_denoising_train.pdf}
...
\begin{figure}
    \centering
%		\includegraphics[width=0.8\textwidth]{fig-UNet_100_denoising_test.pdf}\\
